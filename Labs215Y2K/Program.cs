...
namespace Labs215Y2K
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" Данные другого счёта");

            Account acc3 = new Account();
            acc3.Name = "Артём";
            Console.WriteLine(acc3.Name);

            acc3.Balance = 1000;
            Console.WriteLine(acc3.Balance + " рублей");

            acc3.Age = 16;
            Console.WriteLine(acc3.Age);

            acc3.Id = "A2qsfd3";
            Console.WriteLine(acc3.Id);

            acc3.YearOfBirth = 2004;
            Console.WriteLine(acc3.YearOfBirth);
            ...
            Console.WriteLine(" Перевод другому клиенту - нажмите 3");
        ...
        public static void Perevoddrugu(Account acc1, Account acc3)
        {
            Console.WriteLine("Введите сумму для перевода другу");
            ...
            acc3.Balance += summaperevoda;


            Console.WriteLine(acc3.Balance + " счёт друга");
            Console.WriteLine(acc1.Balance + " рублей на вашем счёт");
